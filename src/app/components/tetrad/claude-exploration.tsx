...
interface ClaudeExplorationProps {
  explorations: Exploration[];
}

export const ClaudeExploration: React.FC<ClaudeExplorationProps> = ({ explorations }) => {
  if (!explorations.length) return null;

  return (
    <SoftUICard>
      <SoftUICardHeader>
        <SoftUICardTitle>Exploring McLuhan&apos;s Tetrad Analysis - Claude</SoftUICardTitle>
      </SoftUICardHeader>
      <SoftUICardContent>
